...
from ProgressiveSR_EDSR.DataLoader_ImageSR.data_v12v13 import Test
...
if __name__ == '__main__':
    ...
    chpoint = torch.load("../../ProgressiveSR_EDSR/experiment_EDSR/v13/CS_EDSR_P2P_x4_best.pt")
    ...
    output_dir = f"./results/hcd_v13_base_hcd_v2/{data_name}/"
    ...
    for test_batch, (_, hr_img, target_img, filename) in enumerate(test_data, start=0):
        ...
        lr_v11 = torch.load(f"./results/hcd_v11_base_hcd_v2/{data_name}/{filename[0][:-4]}/best_x.pt")

        y = optimize_hr(logger, P2Pnet, hr_img, target_img,lr_v11,15,0.3, 20 / 255, path)
