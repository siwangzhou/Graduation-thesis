...
from ProgressiveSR_EDSR.DataLoader_ImageSR.data_v3v4 import Test
...
if __name__ == '__main__':
    ...
    chpoint = torch.load("../../ProgressiveSR_EDSR/experiment_EDSR/v4/CS_EDSR_P2P_x4_best.pt")
    ...
    for test_batch, (_, hr_img, target_img, filename) in enumerate(test_data, start=0):
        ...
        # _, lr_v2 = load_image(f"../../ProgressiveSR_EDSR/results/{data_name}/out_v2/lr/{filename[0]}")
