...
from EDSR_HCD.utils import AverageMeter
from ProgressiveSR_EDSR.ops.EDSR import LR_SR_x4_v11_quant
from ProgressiveSR_EDSR.DataLoader_ImageSR.data_v10v11 import Test
from EDSR_HCD.utils_hcd import *
...
if __name__ == '__main__':
    ...
    chpoint = torch.load("../../ProgressiveSR_EDSR/experiment_EDSR/v11/CS_EDSR_P2P_x4_best.pt")
    ...
    output_dir = f"./results/hcd_v11_base_hcd_v2/{data_name}/"
    ...
    for test_batch, (_, hr_img, target_img, filename) in enumerate(test_data, start=0):
        ...
        lr_v9 = torch.load(f"./results/hcd_v9_base_hcd_v2/{data_name}/{filename[0][:-4]}/best_x.pt")

        y = optimize_hr(logger, P2Pnet, hr_img, target_img,lr_v9,15,0.3, 20 / 255, path)
