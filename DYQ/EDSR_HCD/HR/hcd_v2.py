...
from ProgressiveSR_EDSR.ops.EDSR import LR_SR_x4_v2_quant
from ProgressiveSR_EDSR.DataLoader_ImageSR.data_v1v2 import Test
...
def optimize_hr(logger, net, y, gt, Ny, epsilon, alpha, output_dir):
...
if __name__ == '__main__':
    ...
    chpoint = torch.load("../../ProgressiveSR_EDSR/experiment_EDSR/v2/CS_EDSR_P2P_x4_best.pt")
    ...
    output_dir = f"./results/hcd_v2/{data_name}/"
    ...
    for test_batch, (_, hr_img, target_img, filename) in enumerate(test_data, start=0):
        ...
        y = optimize_hr(logger, P2Pnet, hr_img, target_img,15,0.3, 20 / 255, path)
