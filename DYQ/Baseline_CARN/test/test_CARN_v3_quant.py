...
from Baseline_CARN.ops.CARN import LR_SR_x4_v3_quant
from Baseline_CARN.DataLoader_ImageSR.data_v3v4 import Test
...
P2Pnet = LR_SR_x4_v3_quant(kwards=kwards).cuda()
chpoint= torch.load("../experiment_CARN/v3/CS_CARN_P2P_x4_best.pt")
...
output_dir = '../results/manga109/out_v3/'
