...
from Baseline_CARN.ops.CARN import LR_SR_x4_v8_quant
from Baseline_CARN.DataLoader_ImageSR.data_v8v9 import Test
...
P2Pnet = LR_SR_x4_v8_quant(kwards=kwards).cuda()
chpoint= torch.load("../experiment_CARN/v8/CS_CARN_P2P_x4_best.pt")
...
output_dir = '../results/manga109/out_v8/'
