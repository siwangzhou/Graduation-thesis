...
from Baseline_CARN.ops.CARN import LR_SR_x4_v12_quant
from Baseline_CARN.DataLoader_ImageSR.data_v12v13 import Test
from torchvision.utils import save_image
from Baseline_CARN.utils import *
...
P2Pnet = LR_SR_x4_v12_quant(kwards=kwards).cuda()
chpoint= torch.load("../experiment_CARN/v12/CS_CARN_P2P_x4_best.pt")
...
output_dir = '../results/manga109/out_v12/'
