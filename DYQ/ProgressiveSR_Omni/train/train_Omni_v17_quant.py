...
from ProgressiveSR_Omni.ops.OmniSR import LR_SR_x4_v17_quant
from ProgressiveSR_Omni.DataLoader_ImageSR.data_v16v17 import MyDataset, Test
from ProgressiveSR_Omni.utils import *
...
if __name__ == '__main__':
    ...
    chpoint = torch.load("../experiment_Omni/v2/CS_Omni_P2P_x4_best.pt")
    ...
    chpoint2 = torch.load("../experiment_Omni/v4/CS_Omni_P2P_x4_best.pt")
    ...
    chpoint3 = torch.load("../experiment_Omni/v7/CS_Omni_P2P_x4_best.pt")
    ...
    chpoint4 = torch.load("../experiment_Omni/v9/CS_Omni_P2P_x4_best.pt")
    ...
    chpoint5 = torch.load("../experiment_Omni/v11/CS_Omni_P2P_x4_best.pt")
    ...
    chpoint6 = torch.load("../experiment_Omni/v13/CS_Omni_P2P_x4_best.pt")
    ...
    chpoint7 = torch.load("../experiment_Omni/v15/CS_Omni_P2P_x4_best.pt")
    ...
    for epoch in range(start_epochs, epochs+1):
        ...
        if epoch % 1 == 0:
            ...
            if avg_y_psnr > best_psnr:
                ...
                torch.save(checkpoint_best, os.path.join(model_dir, 'CS_Omni_P2P_x4_best.pt'))
        ...
        torch.save(checkpoint_latest, os.path.join(model_dir, 'CS_Omni_P2P_x4_latest.pt'))
        ...
        fp = open(os.path.join(model_dir, 'CS_Omni_P2P_x4.txt'), 'a+')
        fp.write(str_write)
        fp.close()
