...
from ProgressiveSR_EDSR.ops.EDSR import LR_SR_x4_v15_quant
from ProgressiveSR_EDSR.DataLoader_ImageSR.data_v14v15 import MyDataset, Test
...
if __name__ == '__main__':
    ...
    net_G = LR_SR_x4_v15_quant(kwards=kwards).cuda()
