...
if __name__ == '__main__':
    ...
    for test_batch, (_, hr_img, target_img, filename) in enumerate(test_data, start=0):
        output_dir = f"./results/hcd_v11_base_hcd_v2/Set5/"
        ...
        lr_v9 = torch.load(f"./results/hcd_v9_base_hcd_v2/Set5/{filename[0][:-4]}/best_x.pt")

        logger = setup_logging(os.path.join(output_dir, 'log.txt'))

        y = optimize_lr(logger, P2Pnet, hr_img, target_img, lr_v9, 15, 0.3, 20 / 255, path)
