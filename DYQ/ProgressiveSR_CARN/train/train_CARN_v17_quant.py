...
from ProgressiveSR_CARN.DataLoader_ImageSR.data_v16v17 import MyDataset, Test
...
if __name__ == '__main__':
    ...
    chpoint = torch.load("../experiment_CARN/v2/CS_CARN_P2P_x4_best.pt")
