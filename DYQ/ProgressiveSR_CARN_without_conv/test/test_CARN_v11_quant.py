...
from ProgressiveSR_CARN_without_conv.DataLoader_ImageSR.data_v10v11 import Test
...
chpoint= torch.load("../experiment_CARN_without_conv/v11/CS_CARN_P2P_x4_best.pt")
...
data_test = Test(["C:/DATASETS/Image-SR/manga109/HR"])
...
output_dir = '../results/manga109/out_v11/'
