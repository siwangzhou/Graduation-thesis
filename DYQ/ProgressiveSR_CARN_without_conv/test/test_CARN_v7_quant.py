...
from ProgressiveSR_CARN_without_conv.ops.CARN_without_conv import LR_SR_x4_v7_quant
from ProgressiveSR_CARN_without_conv.DataLoader_ImageSR.data_v6v7 import Test
...
chpoint= torch.load("../experiment_CARN_without_conv/v7/CS_CARN_P2P_x4_best.pt")
...
output_dir = '../results/manga109/out_v7/'
