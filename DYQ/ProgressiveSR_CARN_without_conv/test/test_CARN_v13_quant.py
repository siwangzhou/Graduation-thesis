...
from ProgressiveSR_CARN_without_conv.DataLoader_ImageSR.data_v12v13 import Test
...
chpoint= torch.load("../experiment_CARN_without_conv/v13/CS_CARN_P2P_x4_best.pt")
...
output_dir = '../results/manga109/out_v13/'
