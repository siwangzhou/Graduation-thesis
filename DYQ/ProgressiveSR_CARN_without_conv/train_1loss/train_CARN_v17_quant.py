...
from ProgressiveSR_CARN_without_conv.DataLoader_ImageSR.data_v16v17 import MyDataset, Test
from ProgressiveSR_CARN_without_conv.ops.CARN_without_conv import LR_SR_x4_v17_quant
from ProgressiveSR_CARN_without_conv.utils import *
...
if __name__ == '__main__':
    ...
    chpoint2 = torch.load("../experiment_CARN_without_conv_1loss/v4/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint3 = torch.load("../experiment_CARN_without_conv_1loss/v7/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint4 = torch.load("../experiment_CARN_without_conv_1loss/v9/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint5 = torch.load("../experiment_CARN_without_conv_1loss/v11/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint6 = torch.load("../experiment_CARN_without_conv_1loss/v13/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint7 = torch.load("../experiment_CARN_without_conv_1loss/v15/CS_CARN_P2P_x4_best.pt")
    ...
    model_dir = "../experiment_CARN_without_conv_1loss/v17"
    mkdirs(model_dir)
