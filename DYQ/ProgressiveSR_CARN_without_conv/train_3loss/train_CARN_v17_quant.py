...
if __name__ == '__main__':
    ...
    chpoint2 = torch.load("../experiment_CARN_without_conv/v4/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint3 = torch.load("../experiment_CARN_without_conv/v7/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint4 = torch.load("../experiment_CARN_without_conv/v9/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint5 = torch.load("../experiment_CARN_without_conv/v11/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint6 = torch.load("../experiment_CARN_without_conv/v13/CS_CARN_P2P_x4_best.pt")
    ...
    chpoint7 = torch.load("../experiment_CARN_without_conv/v15/CS_CARN_P2P_x4_best.pt")
    ...
    model_dir = "../experiment_CARN_without_conv/v17"
    mkdirs(model_dir)
